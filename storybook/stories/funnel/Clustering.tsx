...
import { ResponsiveWaffle } from '@anarock/nivo-waffle'
    ...
    return (
        <>
            ...
            >
                ...
                <code>@anarock/nivo-waffle</code> package to show clustering by gender, and the{' '}
                <code>Bar</code> component from <code>@anarock/nivo-bar</code> to show the repartition by
                age.
                <br />
