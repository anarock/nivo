...
import { usePropertyAccessor, useValueFormatter } from '@anarock/nivo-core'
...
import { ScaleLinear, ScaleLinearSpec, ScaleTime, ScaleTimeSpec } from '@anarock/nivo-scales'
import {
    computeValueScale,
    computeOrdinalScale,
    getSizeGenerator,
